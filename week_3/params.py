...
default_cfg.PROJECT_NAME = "mlops-course-assgn3"
...
default_cfg.GRADIENT_ACCUMULATION_STEPS = 1
...
default_cfg.MODEL_DATA_FOLDER = f'{default_cfg.MODEL_NAME[10:]}_goodreads'
#default_cfg.MODEL_DATA_FOLDER = 'tiny_bert_goodreads'

# HUB PARAMETERS
default_cfg.PUSH_TO_HUB = True
default_cfg.HUB_MODEL_ID = f"dhmeltzer/{default_cfg.MODEL_NAME[10:]}-goodreads-wandb"
